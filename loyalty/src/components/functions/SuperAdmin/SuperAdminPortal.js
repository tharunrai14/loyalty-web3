  ...
  return (
    <div className={superAdminStyles.outerbox}>
      <div className={superAdminStyles.adminSection}>
        <label className={superAdminStyles.label} htmlFor="checkAdmin">
          Admin Address:
        </label>
        <input
        ...
        />
        <button className={superAdminStyles.button} onClick={checkAdmin}>
          Check Admin
        </button>
      </div>
      <div className={superAdminStyles.adminSection}>
        <label className={superAdminStyles.label} htmlFor="adminAddress">
          Admin Address:
        </label>
        <input
          className={superAdminStyles.inputField}
        ...
        <div className={superAdminStyles.buttonContainer}>
          <button className={superAdminStyles.button} onClick={addAdmin}>
            Add Admin
          </button>
          <button className={superAdminStyles.button} onClick={removeAdmin}>
            Remove Admin
          </button>
        </div>
      </div>
