...
function RewardForPurchase() {
  ...
  return (
    <div className={rewardStyles.rewardSection}>
      ...
      <h4 className={rewardStyles.portalbalance}>
        Portal Balance: {balance.toString()}
      </h4>
      <form className={rewardStyles.form} onSubmit={handleReward}>
        <label className={rewardStyles.label} htmlFor="userAddress">
          User Address:
        </label>
        <input
        ...
        />
        <label className={rewardStyles.label} htmlFor="purchaseAmount">
          Purchase Amount:
        </label>
        <input
          className={rewardStyles.inputField}
        ...
        />
        <label className={rewardStyles.label} htmlFor="multiplier">
          Multiplier:
        </label>
        <input
          className={rewardStyles.inputField}
        ...
        <div className={rewardStyles.buttonContainer}>
          <button className={rewardStyles.button} type="submit">
            Reward User
          </button>
        </div>
      </form>
